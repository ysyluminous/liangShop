...
<div class="register-box">
  <div class="register-logo">
    <a href="../../index2.html"><b>亮亮商城</b>系统</a>
  </div>
	
  <div class="register-box-body">
    <p class="login-box-msg">商家账号注册</p>

     <form action="regiter" method="post">
  
      <div class="form-group has-feedback">
        <input type="text" class="form-control" placeholder="姓名" name="merchantName">
        <span class="glyphicon glyphicon-user form-control-feedback"></span>
      </div>
       <div class="form-group has-feedback">
        <input type="text" class="form-control" placeholder="店铺名称" name="merchantShopName">
        <span class="glyphicon glyphicon-lock form-control-feedback"></span>
      </div>
     
       <div class="form-group has-feedback">
        <input type="text" class="form-control" placeholder="账号" name="merchantAccount">
        <span class="glyphicon glyphicon-lock form-control-feedback"></span>
      </div>
        <div class="form-group has-feedback">
        <input type="password" class="form-control" placeholder="密码" name="merchantPassword">
        <span class="glyphicon glyphicon-lock form-control-feedback"></span>
      </div>
      <div class="form-group has-feedback">
        <input type="text" class="form-control" placeholder="经营范围" name="merchantScope">
        <span class="glyphicon glyphicon-lock form-control-feedback"></span>
      </div>
